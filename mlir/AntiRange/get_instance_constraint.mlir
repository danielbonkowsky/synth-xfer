...
^bb0(%arg0: !transfer.abs_value<[!transfer.integer, !transfer.integer]>, %inst: !transfer.integer):
    ...
    %cmp1 = "transfer.cmp"(%arg00, %inst){predicate=8:i64}:(!transfer.integer, !transfer.integer) -> i1
    %cmp2="transfer.cmp"(%inst,%arg01){predicate=8:i64}:(!transfer.integer, !transfer.integer) -> i1
    %result="arith.ori"(%cmp1,%cmp2):(i1,i1)->i1
